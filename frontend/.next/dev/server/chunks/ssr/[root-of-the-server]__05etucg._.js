...
const metadata = {
    ...
    description: "BidLive é uma plataforma de leilões em tempo real onde os utilizadores fazem lances ao vivo, interagem por chat e recebem recomendações inteligentes baseadas no comportamento e dados em streaming.",
    keywords: [
        "leilões",
