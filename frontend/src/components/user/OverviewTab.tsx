...
export default function OverviewTab({
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-6 items-start animate-in fade-in slide-in-from-bottom-3 duration-300 select-none text-foreground w-full">
      
      {/* LEFT COLUMN: ACTIVITY & DASHBOARD */}
      <div className="space-y-6 min-w-0">
        
        {/* Welcome header card */}
        <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background border border-primary/15 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4 text-left">
          <div>
      ...
      {/* RIGHT COLUMN: PERFIL & SETTINGS FORM */}
      <div className="space-y-6 w-full shrink-0">
        
        {/* Profile Card & Avatar Upload */}
        <div className="bg-card border border-border rounded-2xl p-6 shadow-sm flex flex-col items-center text-center gap-4">
          ...
          <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-4">
            ...
            <div className="space-y-3.5">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-xl bg-background text-foreground text-xs outline-none transition duration-150 ${
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className={`w-full px-3 py-2 border rounded-xl bg-background text-foreground text-xs outline-none resize-none transition duration-150 ${
                    profileErrors.bio
                      ? "border-destructive focus:ring-1 focus:ring-destructive focus:border-destructive"
                      : "border-border focus:ring-1 focus:ring-primary focus:border-primary"
                  }`}
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-bold rounded-xl shadow-sm transition uppercase cursor-pointer disabled:opacity-50 border-none"
              >
            ...
            >
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-primary text-primary-foreground text-xs font-bold rounded-xl shadow-sm transition uppercase cursor-pointer disabled:opacity-50 border-none"
                >
                  <Save className="w-3.5 h-3.5" />
