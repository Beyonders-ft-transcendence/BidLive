...
export default function MainHeader({
  ...
  return (
    <header className="bg-white border-b border-gray-100 shadow-sm relative z-20">
      <div className="max-w-7xl mx-auto flex flex-row min-h-[80px] lg:min-h-[96px] items-center justify-between px-4 py-3 lg:py-0 gap-3 sm:gap-4">
        <div className="flex items-center gap-3 flex-shrink-0">
          <div>
            <Image src={icon} alt="BidLive" width={120} height={36} className="h-6 sm:h-8 lg:h-10 w-auto object-contain" />
          </div>
        </div>
        <div className="flex max-w-xl w-full ml-auto">
          <form onSubmit={onSubmitSearch} className="flex w-full overflow-hidden rounded-sm border-2 border-gray-200 focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/10 transition-all bg-white shadow-sm hover:border-gray-300">
            ...
            <input
              ...
              className="flex-1 px-3 md:px-5 py-2 md:py-3 text-[11px] md:text-sm outline-none text-gray-800 placeholder-gray-400 font-medium"
            />
