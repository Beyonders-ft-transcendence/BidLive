...
export default function Button({
	...
	const baseStyles =
		"inline-flex cursor-pointer items-center justify-center rounded px-4 py-3 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-60 disabled:cursor-not-allowed";
